...
contract WTMT is ITokenDeposit {
    string public name = "Wrapped TMT";
    string public symbol = "WTMT";
    uint8  public decimals = 6;
    trcToken  public tmtTokenId = trcToken(1003421);
    ...
    function deposit() public payable {
        require(msg.tokenid == tmtTokenId, "deposit tokenId not TMT[1003421]");
    ...
    function withdraw(uint256 sad) public {
        require(balanceOf_[msg.sender] >= sad, "not enough WTMT balance");
        require(totalSupply_ >= sad, "not enough WTMT totalSupply");
        balanceOf_[msg.sender] -= sad;
        totalSupply_ -= sad;
        msg.sender.transferToken(sad, tmtTokenId);
